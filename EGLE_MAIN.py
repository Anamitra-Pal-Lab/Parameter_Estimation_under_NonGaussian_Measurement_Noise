...
from EGLE_Estimation import EGLE_Initialization
...
def EGLE_Parameter_Estimation_Step(x_curr_hat, secondary_loop_max_iter):
    ...
    for j1 in range(secondary_loop_max_iter):
        ...
        print('loss function value is: ' + str(np.linalg.norm(g_x_GMM_hat_gen(x_curr_hat))) )
...
Max_iter =5 # Setting maximum number of iterations
...
[mu_cGj_hat_list,mu_DGj_hat_list, Sigma_cGj_hat_list, Sigma_DGj_hat_list, c_j_hat_list, D_1j_hat_list] = EGLE_Initialization(Mu_vector_init, Sigma_vector_init,mu_cGj_hat_list, mu_DGj_hat_list, Sigma_cGj_hat_list, Sigma_DGj_hat_list, m, x_IG_hat,  c_hat, D_hat)
